 ...
 *    #####.
 *    112111
 *    you in this case the marked nodes dont take up a range(of special nodes)
 *    and if you do assume that you get a better answer than possible. (special nodes also get deleted if they are marked, if they dont, above case breaks alot)
 *    edge cases when a_i=0, as it isnt a range?
 */
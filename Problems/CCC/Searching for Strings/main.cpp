...
lli base6=67;
lli mod6=2e9+11;
lli bases[kek]={73,79,101,103,107,937,937,997,997,1013,1013};
lli mods[kek]={(lli)1e9+7,(lli)1e9+9,(lli)2e9+11,(lli)984979187,(lli)984979187,984979187,(lli)(1e9)+7,(lli)2e9+11,(lli)1e9+9,(lli)1e9+9,984979187};
    ...
    for(lli i=0;i<hs;i++){
        ...
        if(work&&i+1-ns>=0){
            ...
            if(work){
                ...
                work=false;
                for (int j = 0; j < kek; j++) {
                    if (!dones[j].count(tes[j]))work = true;
                }
                if(!done.count(te)||!done2.count(te2)||!done3.count(te3)||!done4.count(te4)||!done5.count(te5)||!done6.count(te6)||work) {
